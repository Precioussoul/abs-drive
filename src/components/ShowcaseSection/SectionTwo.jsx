    ...
    <div className="sectionTwo">
      <div data-aos="fade-right" className="text-showcase">
        ...
        <p className="text-showcase-desc">
          ABS Drive Clean and Beautify your new home for your files with great
      ...
      <div data-aos="fade-left" className="images-showcase secTwo">
        {mode === "dark" ? (
          <img src="images/hbs-desk-dark.png" alt="abs drive desktop view" />
        ) : (
          <img src="images/hbs-desk-white.png" alt="abs drive desktop view" />
        )}
      </div>
    </div>
  );
