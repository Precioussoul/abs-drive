  ...
  return (
    <div className="sectionOne">
      <div data-aos="fade-down" className="images-showcase">
        {mode === "light" ? (
          <img src="images/hbs-mob.png" alt="Abs drive login" />
        ) : (
          <img src="images/hbs-login-dark.png" alt="Abs drive login" />
        )}
      </div>
      <div data-aos="fade-up" className="text-showcase">
        ...
        <p className="text-showcase-desc">
          ...
          intruder accessing your files. ABS Drive is secured with multiple
          layer of data protection. You are in control of everything here.
        </p>
      </div>
    </div>
  );
